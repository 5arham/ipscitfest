...
| IPSC_Schedule (Drive, 7 Sep 2026) | The provisional running order |
...
row whether or not it exists yet: an unreleased one shows "First week of October
2026" instead of a download button, so a school can tell the difference between
...
across all 18 pages. Light and dark are both designed; the toggle is in the bar
